...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="video-container">
            <video src="././asset/image/hijaukeun.mp4" loop autoplay muted></video>
        </div>
...
<section class="icons-container" id="service">
    ...
    <div class="icons">
        <img src="/./asset/image/icon-3.png" alt="">
        <div class="info">
            <h3>Request</h3>
    ...
    <div class="icons">
        <img src="././asset/image/icon-4.png" alt="">
        <div class="info">
            <h3>secure donate</h3>
...
<section class="donate" id="donation">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="././asset/image/HUTAN1.jpeg" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="././asset/image/HUTAN2.jpg" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="././asset/image/HUTAN3.jpg" alt="">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="././asset/image/HUTAN4.jpg" alt="">
                <div class="icons">
