  ...
  <div class="container px-6 mx-auto grid">
    ...
    <form action="{{ route('pengaduan.store')}} " method="POST" enctype="multipart/form-data">
      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <button type="submit"
          class="mt-4 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple">
          Ajukan
        </button>
